(function() {
	var h = {},
		mt = {},
		c = {
			id: "dbdd94468cf0ef471455c47f380f58d2",
//			dm: ["to8to.com", "mipcache.bdstatic.com", "m-to8to-com.mipcdn.com"],
//			js: "tongji.baidu.com/hm-web/js/",
			...
			cvcf: ['btn_free', 'submitCode', 'zxd-form-submit'],
			apps: ''
		};
	var r = void 0,
		s = !0,
	...
	h.m = {
		...
		P: y() || "https:" === document.location.protocol ? "https:" : "http:",
		fb: 0,
		Ua: 6E5,
		hb: 5E3,
		Va: 5,
	...
	(function() {
		...
		function b() {
			...
			if((!l || !e) && p && k) z = s, m = +new Date;
			else if(l && e && (!p || !k)) z = u, q += +new Date - m;
			l = p;
			e = k;
			C = setTimeout(b, 100)
		}
			...
			e = {
				...
				init: function() {
					...
					l.c("stag-b", function() {
						...
						h.b.a.ct = [decodeURIComponent(h.b.getData("Hm_ct_" + c.id) || ""), e.p.T, e.p.page].join("!")
					});
					l.c("stag-d", function() {
						h.b.a.api = 0;
						e.e = 0;
				...
				oa: function() {
					...
					if(a && a.cmd && a.cmd[c.id])
						for(var d = a.cmd[c.id], b = /^_track(Event|MobConv|Order|RTEvent)$/, q = 0, f = d.length; q < f; q++) {
							var v = d[q];
				...
				_trackRTEvent: function(a) {
					...
					if(d.d(a, "Object")) {
						...
						if(900 >= m) g.call(this, a);
							...
							for(var m = Math.ceil(m / 900), q = "block|" + Math.round(Math.random() * n.A).toString(16) + "|" + m + "|", l = [], v = 0; v < m; v++) l.push(v), l.push(a.substring(900 * v, 900 * v + 900)), g.call(this, q + l.join("|")), l = []
					}
				},
	...
	(function() {
		function a() {
			"undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = s, this.a = {}, this.Z = s, this.N = u, this.init())
		}
		var b = mt.url,
			d = mt.da,
			f = mt.S,
		...
		a.prototype = {
			...
			J: function() {
				for(var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++)
					if(this.O(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
				return a
			},
			X: function() {
			...
			va: function() {
				if(!document.referrer) return k.o - k.s > c.vdur ? 1 : 4;
				var a = u;
				this.C(document.referrer) && this.C(document.location.href) ? a = s : (a = b.Y(document.referrer), a = this.O(a || "", document.location.hostname));
				return a ? k.o - k.s > c.vdur ? 1 : 4 : 3
			},
			getData: function(a) {
				try {
			...
			La: function() {
				...
				if(d = this.getData("Hm_lvt_" + c.id)) {
					...
					for(; 2592E3 < k.o - e[0];) e.shift();
					f = 4 > e.length ? 2 : 3;
					for(1 === a && e.push(k.o); 4 < e.length;) e.shift();
					d = e.join(",");
					e = e[e.length - 1]
				} else d = k.o, e = "", f = 1;
				this.setData("Hm_lvt_" + c.id, d, c.age);
				this.setData("Hm_lpvt_" + c.id, k.o);
				d = k.o === this.getData("Hm_lpvt_" + c.id) ? "1" : "0";
			...
			init: function() {
				try {
					this.Ma(), 0 === this.a.nv ? this.Ja() : this.R(".*"), h.b = this, this.ka(), w.B("pv-b"), this.Ia()
				} catch(a) {
					var b = [];
					b.push("si=" + c.id);
			...
			Ia: function() {
				...
				this.Z ? (this.N = s, this.a.et = 0, this.a.ep = "", this.a.vl = l.L() + l.M(), this.k(a)) : a()
			},
			k: function(a) {
				var b = this;
			...
			ka: function() {
				...
				a && (d.test(a) && e && g) && (this.a.rnd = Math.round(Math.random() * k.A), a =
					document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", k.protocol + "//" + c.js + f + ".js?" + this.a.rnd), f = document.getElementsByTagName("script")[0], f.parentNode.insertBefore(a, f))
			},
			ga: function(a) {
	...
	var A = h.m,
		B = h.load;
	if(c.apps) {
		var D = [A.protocol, "//ers.baidu.com/app/s.js?"];
		D.push(c.apps);
		B(D.join(""))
	}
	var E = h.m,
				...
				w = function(a, d) {
					...
					if(d) {
						var k = d.getAttribute("href"),
							n = d.getAttribute("onclick") ? "" + d.getAttribute("onclick") : t,
							m = d.getAttribute("id") || "";
			...
			if("undefined" !== typeof p && "undefined" !== typeof l) {
				...
				d.c(document, "mousedown", function(a) {
					...
					for(k(p, function(a, e) {
						...
						q !== document && k(d, z) !== u;) q = q.parentNode
				})
			}
		}
	})();
	(function() {
		...
		if("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
			var g = {
				fa: function() {
					for(var b = c.cvcf.length, f, p = 0; p < b; p++)(f = a.W(decodeURIComponent(c.cvcf[p]))) && d.c(f, "click", g.na())
				},
				na: function() {
					return function() {
						h.b.a.et = 86;
