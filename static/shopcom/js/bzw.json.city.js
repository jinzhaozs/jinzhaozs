$(function () {
    if ($(".ProvinceSelect").length > 0) {
        //初始化省市县数据
        var ProvinceID = $("[name='F_ProvinceID']").val();
        var CityID = $("[name='F_CityID']").val();
        var AreaID = $("[name='F_AreaID']").val();
        //定义县区选择框事件
        $(".AreaSelect").change(function () {
            $("[name='F_AreaID']").val($(this).val());
        });
        //定义城市选择框事件
        ...
        $(".ProvinceSelect").change(function () {
            ...
            if (province == "1") {
                ...
                for (var i = 0; i < ProvinceMap[province].length; i++) {
                    $(".CitySelect").append("<option value='" + ProvinceMap[province][i].id + "'>" + ProvinceMap[province][i].value + "</option>");
                }
                $(".CitySelect").find("option:eq(0)").prop("selected", true);
                $("[name='F_CityID']").val($(".CitySelect").find("option:eq(0)").attr("value"));
            }
...
function getProvCity(cid) {
    var ret = '全国'
    var scid = cid.toString();
    if (parseInt(cid) > 0) {
        var pid = parseInt(scid.substring(0, 2) + "0000");
        ...
        var c = ProvinceMap[pid.toString()];
        for (var i in c) {
            if (c[i].id == scid) {
                ret = ret + "-" + c[i].value;
                break;
...
{ id: 620000, val: "甘肃省" },
{ id: 630000, val: "青海省" },
{ id: 640000, val: "宁夏回族自治区" },
{ id: 650000, val: "新疆维吾尔自治区" },
{ id: 710000, val: "台湾省" },
{ id: 810000, val: "香港特别行政区" },
{ id: 820000, val: "澳门特别行政区" },
];
var ProvinceMap = {};
ProvinceMap["110000"] = [{
    id: "110100",
