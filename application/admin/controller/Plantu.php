...
class Plantu extends \app\admin\controller\Base
{
    ...
    public function woshiadd(){
        ...
        $user_info = $user->insert($shuju);//主表添加 
        if (!$user_info) {
           $this->error("添加失败","admin/plantu/woshiindex",['comid'=>$shuju['comid'],'planid'=>$shuju['planid']]);
        }else{
           $this->redirect("admin/plantu/woshiindex",['comid'=>$shuju['comid'],'planid'=>$shuju['planid']]);
        }
    }
    //卧室edit
    ...
    public function ertongjianadd(){
        ...
        $user_info = $user->insert($shuju);//主表添加 
        if (!$user_info) {
           $this->error("添加失败","admin/plantu/ertongjianindex",['comid'=>$shuju['comid'],'planid'=>$shuju['planid']]);
        }else{
           $this->redirect("admin/plantu/ertongjianindex",['comid'=>$shuju['comid'],'planid'=>$shuju['planid']]);
        }
    }
    //儿童间edit
    ...
    public function weishengjianadd(){
        ...
        $user_info = $user->insert($shuju);//主表添加 
        if (!$user_info) {
           $this->error("添加失败","admin/plantu/weishengjianindex",['comid'=>$shuju['comid'],'planid'=>$shuju['planid']]);
        }else{
           $this->redirect("admin/plantu/weishengjianindex",['comid'=>$shuju['comid'],'planid'=>$shuju['planid']]);
        }
    }
    //卫生间edit
    ...
    public function ketingadd(){
        ...
        $user_info = $user->insert($shuju);//主表添加 
        if (!$user_info) {
           $this->error("添加失败","admin/plantu/ketingindex",['comid'=>$shuju['comid'],'planid'=>$shuju['planid']]);
        }else{
           $this->redirect("admin/plantu/ketingindex",['comid'=>$shuju['comid'],'planid'=>$shuju['planid']]);
        }
    }
    //客厅edit
