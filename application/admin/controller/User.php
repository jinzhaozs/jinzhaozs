...
class User extends Controller
{
	public function index()
	{
    	...
    	$res=$user->field("useradmin.id,usercode,usersub,type,brancode,time,name,code")->join('branch br','useradmin.brancode = br.code','left')->where($where)->order("useradmin.id")->paginate(10,false,['query'=>$urlcanshu,]);
    	$page=$res->render();
    	$branch = $br->select();//类型
