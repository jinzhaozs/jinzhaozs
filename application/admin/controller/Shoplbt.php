...
class Shoplbt extends Controller
{
    ...
    public function add()
    {
        ...
        if (!$user_info) {
           $this->error("添加失败","admin/Shoplbt/index",['comid'=>$shuju['comid']]);
        }else{
           $this->redirect("admin/Shoplbt/index",['comid'=>$shuju['comid']]);
        }
    ...
    public function edit(){
        ...
        if (!$res) {
            $this->error("添加失败","admin/Shoplbt/index",['comid'=>input('post.comid')]);
        }
        else
        {
         $this->redirect("admin/Shoplbt/index",['comid'=>input('post.comid')]);
        }
