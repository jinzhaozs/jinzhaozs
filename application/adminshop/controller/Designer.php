   ...
   function _initialize(){
	 ...
	 public function add()
    {
       ...
       { 
        ...
        if (!$user_info) {
           $this->error("添加失败","adminshop/Designer/index",['id'=>$shuju['shop']]);
        }
        else
        {
          $this->redirect("adminshop/Designer/index",['id'=>$shuju['shop']]);
    ...
    public function edit(){
      ...
      if($file)
       { 
        ...
        if (!$res) {
           $this->error("修改失败","adminshop/Designer/index",['id'=>$shuju['shop']]);
        }
        else
        {
          $this->redirect("adminshop/Designer/index",['id'=>$shuju['shop']]);
