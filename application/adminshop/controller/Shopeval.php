...
class Shopeval extends  \app\adminshop\controller\Base
{
    /**
     * *类型
     ...
     public function add()
    {
        ...
        if (!$user_info) {
           $this->error("添加失败","adminshop/Shopeval/index",['comid'=>$shuju['comid'],'planid'=>$shuju['planid']]);
        }else{
           $this->redirect("adminshop/Shopeval/index",['comid'=>$shuju['comid'],'planid'=>$shuju['planid']]);
        }
    }
     //执行修改
